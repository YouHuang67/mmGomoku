...
class ActionValueEvaluatorV0Rand(nn.Module):
    ...
    def __init__(self,
        ...
        super(ActionValueEvaluatorV0Rand, self).__init__()
    ...
    def forward(self, boards):
        ...
        aug_name = random.choice(self.func_names)
        inputs = self.aug_funcs[aug_name](inputs)
        ...
        logits = self.inv_funcs[aug_name](logits).flatten(1)
...
if __name__ == '__main__':
    import models
    evaluator = ActionValueEvaluatorV0Rand(
        backbone=dict(
            type='SimpleResNet',
            depth=16,
            channels=64,
